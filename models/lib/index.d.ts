...
export declare function type<T extends object>(t: T[]): ChainableAttributeSpec<CollectionConstructor<InstanceType<AnonymousModelConstructor<T>>>>;
export declare function type<T extends Function>(t: T | ChainableAttributeSpec<T>): ChainableAttributeSpec<T>;
export declare function type<T extends object>(t: T): ChainableAttributeSpec<AnonymousModelConstructor<T>>;
